...
class Book(db.Model):
    ...
    book_format = db.Column(db.String(20))
    book_length = db.Column(db.Integer)
    user_token = db.Column(db.String, db.ForeignKey('user.token'), nullable = False)

    def __init__(self, isbn, author,book_title,book_format, book_length, user_token):
        self.isbn = isbn
        self.author = author
...
class BookSchema(ma.Schema):
    class Meta:
        fields = ['isbn', 'author','book_title','book_format', 'book_length']
